...
# queue = np.zeros([256*256*64,3], np.int32)
# state_ctr = np.zeros([256*256*64,2], np.int32)

for i in range(len(obj_names)):
    this_name = target_dir + obj_names[i] + "/model.binvox"
    out_name = target_dir + obj_names[i] + "/model_depth_fusion_512.binvox"
